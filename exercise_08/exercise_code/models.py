...
class Autoencoder(nn.Module):
    ...
    def training_step(self, batch, loss_func):
        ...
        reconstructed = self.forward(images) # Stage 1: Forward().
        loss = loss_func(reconstructed, images) # Compute the loss over the predictions and the ground truth.
    ...
    def validation_step(self, batch, loss_func):
        ...
        reconstruction = self.forward(images) # Stage 1: Forward().
        loss = loss_func(images, reconstruction) # Compute the loss over the predictions and the ground truth.
